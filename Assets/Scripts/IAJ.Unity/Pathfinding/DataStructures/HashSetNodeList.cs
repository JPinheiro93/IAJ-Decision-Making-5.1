...
namespace Assets.Scripts.IAJ.Unity.Pathfinding.DataStructures
{
    ...
    public class HashSetNodeList : IOpenSet, IClosedSet
    {
        private HashSet<NodeRecord> NodeRecords { get; set; }

        public HashSetNodeList()
        {
        ...
        public NodeRecord PeekBest()
        {
            ...
            return this.NodeRecords.Aggregate(
                (nodeRecord1, nodeRecord2) => 
                nodeRecord1.fValue < nodeRecord2.fValue 
                ? nodeRecord1 
                : nodeRecord1.fValue  == nodeRecord2.fValue 
                    ? nodeRecord1.hValue < nodeRecord2.hValue 
                        ? nodeRecord1 
                        : nodeRecord2
                    : nodeRecord2);
        }
